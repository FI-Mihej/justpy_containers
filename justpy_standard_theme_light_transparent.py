...
theme: Theme = {jp.Button: 'select-none h-auto m-2 pt-1 pb-1 pl-3 pr-3 bg-yellow-500 text-black rounded hover:bg-yellow-600 active:bg-yellow-700', 
 jp.Label: 'bg-gray-400 text-gray-800 font-semibold py-1 px-2 border border-gray-400 rounded-r shadow', 
 ...
 jp.Textarea: 'bg-opacity-50 bg-gray-200 text-gray-500 placeholder-gray-400 appearance-none border rounded shadow w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline h-auto', 
 jp.EditorMD: 'bg-opacity-50 bg-gray-400 text-gray-700', 
 jp.Markdown: 'bg-opacity-50 rounded bg-white p-5', 
 jp.PlotlyChart: 'bg-opacity-25 rounded bg-white p-5', 
 ...
 ScreenWithStickyHeaderAndFooter: {'screen': 'bg-opacity-75 bg-gray-100'}, 
 ...
 ThemeSelectorForApp: {'selector':'h-auto text-xs m-2 pt-1 pb-1 pl-3 pr-3 bg-yellow-500 disabled:bg-yellow-100 rounded hover:bg-yellow-600', 
                       'dilabled_selector':'h-auto text-xs m-2 pt-1 pb-1 pl-3 pr-3 bg-yellow-500 disabled:bg-yellow-100 rounded', 
                       'selector_language':'bg-gray-200 text-gray-600 text-xs'}, 
 ...
 HeaderForApp: {'html':'bg-opacity-50 bg-gray-200', 
                'lang_select':{}}, 
 ...
 FooterWithLangSelectForApp: {'html':'bg-opacity-50 bg-gray-200 p-2', 
                              'lang_select':{}}, 
 
 FooterWithLangSelectLayeredForApp: {'html':'bg-opacity-0 bg-gray-200 p-2', 
                                     'lang_select':{}}, 
 ...
 LoginFormForApp: {'background':{'screen': 'opacity-0'}, 
                   'frontend':{},  'form':'m-5 p-3 bg-gray-100 border border-gray-600 rounded-md', 
                   'form_close_button':'text-gray-500 hover:text-gray-900 hover:bg-red-600 rounded', 
                   'form_head':'bg-gray-100 text-yellow-500', 
                   'user_name_label':'text-gray-600 text-xs font-bold', 
                   'user_name_input':'', 
